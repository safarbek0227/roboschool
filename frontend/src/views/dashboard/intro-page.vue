    ...
    return {
      lists: [
        ...
        },
        {
          slug: 'rules',
          linker: 'rules',
          name: 'Don\'t forgot it',
          is_code: false,
          title: `<div class="rules">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 rb-md-none">
          <div class="sticky">
            ...
            <ul class="rb-md-none">
              <li v-for='link in lists' :key="link.id">
                <router-link :to="{ hash: '#' +link.slug}" class="sidebar-links">{{link.linker}}</router-link>
              </li>
              <li>
